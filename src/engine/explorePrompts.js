// src/engine/explorePrompts.js
// Exploration mode prompts — not yet wired into gameplay.
// Translated from explore/prompts.py

export const SCENE_SYSTEM_PROMPT = `You are the narrative engine for Gloamreach's free-roam exploration mode.
...
export const CHOICE_SYSTEM_PROMPT = `You generate a list of short actions a player may take next while exploring.
